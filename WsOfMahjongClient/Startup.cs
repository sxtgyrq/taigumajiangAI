...
namespace WsOfMahjongClient
{
    ...
    {
        internal static string sendInmationToUrlAndGetRes(string roomUrl, string sendMsg)
        {
                        ...
                        {
                            {
                                ...
                                switch (c.c)
                                {
                                    ...
                                    case "PositionSelect":
                                        {
                                            ...
                                            {
                                                PositionSelect ps = Newtonsoft.Json.JsonConvert.DeserializeObject<PositionSelect>(returnResult.result);

                                                Room.PositionSelectF(s, ps);
                                    ...
                                    case "StartPositionSelect":
                                        {
                                            if (s.Ls == LoginState.OnLine)
                                            {
                                                StartPositionSelect sps = Newtonsoft.Json.JsonConvert.DeserializeObject<StartPositionSelect>(returnResult.result);
                                                Room.StartPositionSelectF(s, sps);
                                            }
                                        }; break;
                                    case "CheckSession":
                                        {
